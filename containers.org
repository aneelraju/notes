...
***** demo: cluster setup on aws using kops
      ...
      + % kube get node; # list of nodes; 1 master and 2 nodes
...
***** demo: running first app on kubernetes
      ...
      + % kubectl describe pod nodehelloworld.example.com; # pod details
      + % kubectl port-forward nodehelloworld.example.com 8081:3000; # port forward 3000 to host 8081
      + % curl localhost:8081
        + another way to test is via service
      + 
